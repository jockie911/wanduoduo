...
.method public static setupCandidate(Landroid/media/MediaCodecInfo;Ljava/lang/String;)Ltv/danmaku/ijk/media/player/IjkMediaCodecInfo;
    ...
    .line 192
    iput v5, v0, Ltv/danmaku/ijk/media/player/IjkMediaCodecInfo;->mRank:I
...
.method public dumpProfileLevels(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    iget-object v8, p0, Ltv/danmaku/ijk/media/player/IjkMediaCodecInfo;->mCodecInfo:Landroid/media/MediaCodecInfo;

    invoke-virtual {v8, p1}, Landroid/media/MediaCodecInfo;->getCapabilitiesForType(Ljava/lang/String;)Landroid/media/MediaCodecInfo$CodecCapabilities;
    ...
    .end local v3           #i$:I
    .end local v4           #len$:I
    .end local v7           #profileLevel:Landroid/media/MediaCodecInfo$CodecProfileLevel;
    :cond_2
    const-string v8, "IjkMediaCodecInfo"
    ...
    invoke-static {v6, v5}, Ltv/danmaku/ijk/media/player/IjkMediaCodecInfo;->getProfileLevelName(II)Ljava/lang/String;
    ...
    const-string v9, "profile-level: exception"
