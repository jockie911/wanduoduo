...
.method private handleFinalResult(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;Lcom/facebook/imagepipeline/producers/FetchState;)V
    ...
    invoke-direct {p0, p2, v1}, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->getExtraMap(Lcom/facebook/imagepipeline/producers/FetchState;I)Ljava/util/Map;
    ...
    invoke-direct {p0, p1, v1, v2}, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->notifyConsumer(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;ZLcom/facebook/imagepipeline/producers/Consumer;)V
...
.method private maybeHandleIntermediateResult(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;Lcom/facebook/imagepipeline/producers/FetchState;)V
    ...
    invoke-direct {p0, p1, v2, v3}, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->notifyConsumer(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;ZLcom/facebook/imagepipeline/producers/Consumer;)V
...
.method private notifyConsumer(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;ZLcom/facebook/imagepipeline/producers/Consumer;)V
    ...
    .line 164
    .local v2, result:Lcom/facebook/common/references/CloseableReference;,"Lcom/facebook/common/references/CloseableReference<Lcom/facebook/imagepipeline/memory/PooledByteBuffer;>;"
    const/4 v0, 0x0
...
.method private onResponse(Lcom/facebook/imagepipeline/producers/FetchState;Ljava/io/InputStream;I)V
    ...
    .parameter "responseContentLength"
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
    ...
    .line 94
    iget-object v4, p0, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->mPooledByteBufferFactory:Lcom/facebook/imagepipeline/memory/PooledByteBufferFactory;

    invoke-interface {v4, p3}, Lcom/facebook/imagepipeline/memory/PooledByteBufferFactory;->newOutputStream(I)Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;

    move-result-object v2

    .line 98
    .local v2, pooledOutputStream:Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;
    :goto_0
    iget-object v4, p0, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->mByteArrayPool:Lcom/facebook/imagepipeline/memory/ByteArrayPool;

    const/16 v5, 0x4000

    invoke-interface {v4, v5}, Lcom/facebook/imagepipeline/memory/ByteArrayPool;->get(I)Ljava/lang/Object;
    ...
    invoke-virtual {v2, v0, v4, v1}, Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;->write([BII)V

    .line 104
    invoke-direct {p0, v2, p1}, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->maybeHandleIntermediateResult(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;Lcom/facebook/imagepipeline/producers/FetchState;)V

    .line 105
    invoke-virtual {v2}, Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;->size()I
    ...
    iget-object v5, p0, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->mByteArrayPool:Lcom/facebook/imagepipeline/memory/ByteArrayPool;

    invoke-interface {v5, v0}, Lcom/facebook/imagepipeline/memory/ByteArrayPool;->release(Ljava/lang/Object;)V

    .line 113
    invoke-virtual {v2}, Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;->close()V

    throw v4

    .line 96
    .end local v0           #ioArray:[B
    .end local v2           #pooledOutputStream:Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;
    :cond_1
    iget-object v4, p0, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->mPooledByteBufferFactory:Lcom/facebook/imagepipeline/memory/PooledByteBufferFactory;

    invoke-interface {v4}, Lcom/facebook/imagepipeline/memory/PooledByteBufferFactory;->newOutputStream()Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;

    move-result-object v2

    .restart local v2       #pooledOutputStream:Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;
    goto :goto_0
    ...
    .line 110
    invoke-direct {p0, v2, p1}, Lcom/facebook/imagepipeline/producers/NetworkFetchProducer;->handleFinalResult(Lcom/facebook/imagepipeline/memory/PooledByteBufferOutputStream;Lcom/facebook/imagepipeline/producers/FetchState;)V
    :try_end_1
    ...
    invoke-interface {v4, v0}, Lcom/facebook/imagepipeline/memory/ByteArrayPool;->release(Ljava/lang/Object;)V
