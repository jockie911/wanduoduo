...
.method public static attachTo(Landroid/app/Activity;Ljava/lang/Object;ZLandroid/os/Bundle;)V
    ...
    check-cast v1, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;

    .line 90
    .local v1, fragment:Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;
    if-nez v1, :cond_0

    .line 91
    new-instance v1, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;

    .end local v1           #fragment:Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;
    invoke-direct {v1}, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;-><init>()V

    .line 92
    .restart local v1       #fragment:Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;
    ...
    .line 95
    :cond_0
    iput-boolean p2, v1, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->finishAfterDialog:Z

    .line 96
    iput-object p3, v1, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->argumentsForErrorDialog:Landroid/os/Bundle;

    .line 97
    iput-object p1, v1, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->executionScope:Ljava/lang/Object;
...
.method public onEventMainThread(Lio/rong/eventbus/util/ThrowableFailureEvent;)V
    ...
    .prologue
    .line 65
    iget-object v3, p0, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->executionScope:Ljava/lang/Object;
    ...
    iget-boolean v4, p0, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->finishAfterDialog:Z

    iget-object v5, p0, Lio/rong/eventbus/util/ErrorDialogManager$SupportManagerFragment;->argumentsForErrorDialog:Landroid/os/Bundle;
