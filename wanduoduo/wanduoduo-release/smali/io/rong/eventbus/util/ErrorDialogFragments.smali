...
.method public static handleOnClick(Landroid/content/DialogInterface;ILandroid/app/Activity;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 34
    sget-object v4, Lio/rong/eventbus/util/ErrorDialogFragments;->EVENT_TYPE_ON_CLICK:Ljava/lang/Class;
    ...
    sget-object v4, Lio/rong/eventbus/util/ErrorDialogManager;->factory:Lio/rong/eventbus/util/ErrorDialogFragmentFactory;

    iget-object v4, v4, Lio/rong/eventbus/util/ErrorDialogFragmentFactory;->config:Lio/rong/eventbus/util/ErrorDialogConfig;

    invoke-virtual {v4}, Lio/rong/eventbus/util/ErrorDialogConfig;->getEventBus()Lio/rong/eventbus/EventBus;

    move-result-object v2

    .line 42
    .local v2, eventBus:Lio/rong/eventbus/EventBus;
    invoke-virtual {v2, v1}, Lio/rong/eventbus/EventBus;->post(Ljava/lang/Object;)V

    .line 44
    .end local v1           #event:Ljava/lang/Object;
    .end local v2           #eventBus:Lio/rong/eventbus/EventBus;
    :cond_0
