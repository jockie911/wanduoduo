...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lio/rong/imlib/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;

    .line 1250
    iget-object v1, p0, Lio/rong/imlib/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;
...
.method protected addLogRec(Ljava/lang/String;)V
    ...
    .prologue
    .line 1472
    iget-object v7, p0, Lio/rong/imlib/stateMachine/StateMachine;->mSmHandler:Lio/rong/imlib/stateMachine/StateMachine$SmHandler;

    .line 1473
    .local v7, smh:Lio/rong/imlib/stateMachine/StateMachine$SmHandler;
    if-nez v7, :cond_0
    ...
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1600(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)Lio/rong/imlib/stateMachine/StateMachine$LogRecords;

    move-result-object v0

    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->getCurrentMessage()Landroid/os/Message;
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1000(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)Landroid/os/Message;

    move-result-object v2

    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->getCurrentState()Lio/rong/imlib/stateMachine/IState;
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1100(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)Lio/rong/imlib/stateMachine/IState;
    ...
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1800(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)[Lio/rong/imlib/stateMachine/StateMachine$SmHandler$StateInfo;

    move-result-object v1

    #getter for: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1900(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)I

    move-result v3

    aget-object v1, v1, v3

    iget-object v5, v1, Lio/rong/imlib/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/imlib/stateMachine/State;

    #getter for: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->mDestState:Lio/rong/imlib/stateMachine/State;
    invoke-static {v7}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$2000(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)Lio/rong/imlib/stateMachine/State;
...
.method protected final addState(Lio/rong/imlib/stateMachine/State;)V
    ...
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->addState(Lio/rong/imlib/stateMachine/State;Lio/rong/imlib/stateMachine/State;)Lio/rong/imlib/stateMachine/StateMachine$SmHandler$StateInfo;
...
.method public final copyLogRecs()Ljava/util/Collection;
    ...
    .line 1456
    .local v3, vlr:Ljava/util/Vector;,"Ljava/util/Vector<Lio/rong/imlib/stateMachine/StateMachine$LogRec;>;"
    iget-object v2, p0, Lio/rong/imlib/stateMachine/StateMachine;->mSmHandler:Lio/rong/imlib/stateMachine/StateMachine$SmHandler;

    .line 1457
    .local v2, smh:Lio/rong/imlib/stateMachine/StateMachine$SmHandler;
    if-eqz v2, :cond_0

    .line 1458
    #getter for: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->mLogRecords:Lio/rong/imlib/stateMachine/StateMachine$LogRecords;
    invoke-static {v2}, Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->access$1600(Lio/rong/imlib/stateMachine/StateMachine$SmHandler;)Lio/rong/imlib/stateMachine/StateMachine$LogRecords;

    move-result-object v4

    #getter for: Lio/rong/imlib/stateMachine/StateMachine$LogRecords;->mLogRecVector:Ljava/util/Vector;
    invoke-static {v4}, Lio/rong/imlib/stateMachine/StateMachine$LogRecords;->access$1700(Lio/rong/imlib/stateMachine/StateMachine$LogRecords;)Ljava/util/Vector;
    ...
    check-cast v1, Lio/rong/imlib/stateMachine/StateMachine$LogRec;

    .line 1459
    .local v1, lr:Lio/rong/imlib/stateMachine/StateMachine$LogRec;
    ...
    .end local v1           #lr:Lio/rong/imlib/stateMachine/StateMachine$LogRec;
    :cond_0
    return-object v3
.end method
...
.method protected final deferMessage(Landroid/os/Message;)V
    ...
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->deferMessage(Landroid/os/Message;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lio/rong/imlib/stateMachine/StateMachine$LogRec;->toString()Ljava/lang/String;
    ...
    invoke-interface {v2}, Lio/rong/imlib/stateMachine/IState;->getName()Ljava/lang/String;
...
.method protected final getCurrentMessage()Landroid/os/Message;
    ...
    .line 1307
    .local v0, smh:Lio/rong/imlib/stateMachine/StateMachine$SmHandler;
    if-nez v0, :cond_0
...
.method public final getLogRec(I)Lio/rong/imlib/stateMachine/StateMachine$LogRec;
    ...
    invoke-virtual {v1, p1}, Lio/rong/imlib/stateMachine/StateMachine$LogRecords;->get(I)Lio/rong/imlib/stateMachine/StateMachine$LogRec;
...
.method public final getLogRecCount()I
    ...
    invoke-virtual {v1}, Lio/rong/imlib/stateMachine/StateMachine$LogRecords;->count()I
...
.method public final getLogRecSize()I
    ...
    invoke-virtual {v1}, Lio/rong/imlib/stateMachine/StateMachine$LogRecords;->size()I
...
.method public isDbg()Z
    ...
    :cond_0
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->isDbg()Z
...
.method protected final isQuit(Landroid/os/Message;)Z
    ...
    .line 1874
    :cond_1
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->isQuit(Landroid/os/Message;)Z
...
.method protected final quit()V
    ...
    .line 1885
    :cond_0
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->quit()V
...
.method protected final quitNow()V
    ...
    .line 1896
    :cond_0
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->quitNow()V
...
.method public setDbg(Z)V
    ...
    .line 1920
    :cond_0
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->setDbg(Z)V
...
.method protected final setInitialState(Lio/rong/imlib/stateMachine/State;)V
    ...
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->setInitialState(Lio/rong/imlib/stateMachine/State;)V
...
.method public start()V
    ...
    .line 1932
    :cond_0
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->completeConstruction()V
...
.method protected final transitionTo(Lio/rong/imlib/stateMachine/IState;)V
    ...
    #calls: Lio/rong/imlib/stateMachine/StateMachine$SmHandler;->transitionTo(Lio/rong/imlib/stateMachine/IState;)V
