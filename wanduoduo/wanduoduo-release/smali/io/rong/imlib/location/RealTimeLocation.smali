...
.method public constructor <init>(Landroid/content/Context;Lio/rong/imlib/model/Conversation$ConversationType;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v3}, Lio/rong/imlib/stateMachine/StateMachine;-><init>(Ljava/lang/String;)V

    .line 61
    const/16 v3, 0x2710

    iput v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mRefreshInterval:I

    .line 63
    const/4 v3, 0x5

    iput v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mFilterDistance:I

    .line 65
    iput-wide v6, p0, Lio/rong/imlib/location/RealTimeLocation;->mLatitude:D

    .line 66
    iput-wide v6, p0, Lio/rong/imlib/location/RealTimeLocation;->mLongitude:D

    .line 67
    iput-boolean v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mGpsEnable:Z

    .line 277
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$IdleState;

    invoke-direct {v3, p0, v5}, Lio/rong/imlib/location/RealTimeLocation$IdleState;-><init>(Lio/rong/imlib/location/RealTimeLocation;Lio/rong/imlib/location/RealTimeLocation$1;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mIdleState:Lio/rong/imlib/stateMachine/State;

    .line 325
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$OutgoingState;

    invoke-direct {v3, p0, v5}, Lio/rong/imlib/location/RealTimeLocation$OutgoingState;-><init>(Lio/rong/imlib/location/RealTimeLocation;Lio/rong/imlib/location/RealTimeLocation$1;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mOutgoingState:Lio/rong/imlib/stateMachine/State;

    .line 380
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$IncomingState;

    invoke-direct {v3, p0, v5}, Lio/rong/imlib/location/RealTimeLocation$IncomingState;-><init>(Lio/rong/imlib/location/RealTimeLocation;Lio/rong/imlib/location/RealTimeLocation$1;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mIncomingState:Lio/rong/imlib/stateMachine/State;

    .line 457
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$ConnectedState;

    invoke-direct {v3, p0, v5}, Lio/rong/imlib/location/RealTimeLocation$ConnectedState;-><init>(Lio/rong/imlib/location/RealTimeLocation;Lio/rong/imlib/location/RealTimeLocation$1;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mConnectedState:Lio/rong/imlib/stateMachine/State;

    .line 547
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$TerminalState;

    invoke-direct {v3, p0, v5}, Lio/rong/imlib/location/RealTimeLocation$TerminalState;-><init>(Lio/rong/imlib/location/RealTimeLocation;Lio/rong/imlib/location/RealTimeLocation$1;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mTerminalState:Lio/rong/imlib/stateMachine/State;
    ...
    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mClient:Lio/rong/imlib/NativeClient;

    .line 110
    sget-object v3, Lio/rong/imlib/location/RealTimeLocationConstant$RealTimeLocationStatus;->RC_REAL_TIME_LOCATION_STATUS_IDLE:Lio/rong/imlib/location/RealTimeLocationConstant$RealTimeLocationStatus;

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mCurrentState:Lio/rong/imlib/location/RealTimeLocationConstant$RealTimeLocationStatus;
    ...
    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mParticipants:Ljava/util/ArrayList;
    ...
    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mWatcher:Ljava/util/HashMap;
    ...
    invoke-virtual {v3, p1}, Lio/rong/imlib/navigation/NavigationClient;->getLocationConfig(Landroid/content/Context;)Lio/rong/imlib/navigation/LocationConfig;
    ...
    .line 116
    invoke-virtual {v0}, Lio/rong/imlib/navigation/LocationConfig;->getDistanceFilter()I
    ...
    .line 117
    invoke-virtual {v0}, Lio/rong/imlib/navigation/LocationConfig;->getRefreshInterval()I
    ...
    .line 120
    :cond_0
    new-instance v3, Lio/rong/imlib/location/RealTimeLocation$1;

    invoke-direct {v3, p0}, Lio/rong/imlib/location/RealTimeLocation$1;-><init>(Lio/rong/imlib/location/RealTimeLocation;)V

    iput-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mRefreshRunnable:Ljava/lang/Runnable;
    ...
    .line 134
    iget-object v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mIdleState:Lio/rong/imlib/stateMachine/State;

    invoke-virtual {p0, v2}, Lio/rong/imlib/location/RealTimeLocation;->addState(Lio/rong/imlib/stateMachine/State;)V

    .line 135
    iget-object v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mIncomingState:Lio/rong/imlib/stateMachine/State;

    iget-object v3, p0, Lio/rong/imlib/location/RealTimeLocation;->mIdleState:Lio/rong/imlib/stateMachine/State;

    invoke-virtual {p0, v2, v3}, Lio/rong/imlib/location/RealTimeLocation;->addState(Lio/rong/imlib/stateMachine/State;Lio/rong/imlib/stateMachine/State;)V

    .line 136
    iget-object v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mOutgoingState:Lio/rong/imlib/stateMachine/State;
    ...
    .line 137
    iget-object v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mConnectedState:Lio/rong/imlib/stateMachine/State;
    ...
    .line 138
    iget-object v2, p0, Lio/rong/imlib/location/RealTimeLocation;->mTerminalState:Lio/rong/imlib/stateMachine/State;
    ...
    invoke-virtual {p0, v2}, Lio/rong/imlib/location/RealTimeLocation;->setInitialState(Lio/rong/imlib/stateMachine/State;)V
