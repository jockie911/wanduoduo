...
.method public sendImages(Lio/rong/imlib/model/Conversation$ConversationType;Ljava/lang/String;Ljava/util/List;Z)V
    ...
    .prologue
    .local p3, imageList:Ljava/util/List;,"Ljava/util/List<Landroid/net/Uri;>;"
    const/4 v3, 0x0
    ...
    invoke-static {v7, v7, p4}, Lio/rong/message/ImageMessage;->obtain(Landroid/net/Uri;Landroid/net/Uri;Z)Lio/rong/message/ImageMessage;
    ...
    .line 47
    .local v8, listener:Lio/rong/imkit/RongIM$OnSendMessageListener;
    if-eqz v8, :cond_1
    ...
    invoke-interface {v8, v0}, Lio/rong/imkit/RongIM$OnSendMessageListener;->onSend(Lio/rong/imlib/model/Message;)Lio/rong/imlib/model/Message;
    ...
    .end local v4           #content:Lio/rong/message/ImageMessage;
    ...
    .line 70
    .end local v9           #message:Lio/rong/imlib/model/Message;
    .restart local v4       #content:Lio/rong/message/ImageMessage;
    :cond_1
    invoke-static {}, Lio/rong/imlib/RongIMClient;->getInstance()Lio/rong/imlib/RongIMClient;
    ...
    .end local v8           #listener:Lio/rong/imkit/RongIM$OnSendMessageListener;
    :cond_2
    return-void
.end method
