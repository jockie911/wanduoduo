...
.method protected constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lio/rong/push/common/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;

    .line 1250
    iget-object v1, p0, Lio/rong/push/common/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;
...
.method protected addLogRec(Ljava/lang/String;)V
    ...
    .prologue
    .line 1472
    iget-object v7, p0, Lio/rong/push/common/stateMachine/StateMachine;->mSmHandler:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;

    .line 1473
    .local v7, smh:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;
    if-nez v7, :cond_0
    ...
    .line 1474
    :cond_0
    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mLogRecords:Lio/rong/push/common/stateMachine/StateMachine$LogRecords;
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1600(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)Lio/rong/push/common/stateMachine/StateMachine$LogRecords;

    move-result-object v0

    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->getCurrentMessage()Landroid/os/Message;
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1000(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)Landroid/os/Message;

    move-result-object v2

    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->getCurrentState()Lio/rong/push/common/stateMachine/IState;
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1100(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)Lio/rong/push/common/stateMachine/IState;

    move-result-object v4

    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStack:[Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1800(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)[Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    move-result-object v1

    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1900(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)I

    move-result v3

    aget-object v1, v1, v3

    iget-object v5, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/push/common/stateMachine/State;

    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDestState:Lio/rong/push/common/stateMachine/State;
    invoke-static {v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$2000(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)Lio/rong/push/common/stateMachine/State;
...
.method protected final addState(Lio/rong/push/common/stateMachine/State;)V
    ...
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->addState(Lio/rong/push/common/stateMachine/State;Lio/rong/push/common/stateMachine/State;)Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
...
.method public final copyLogRecs()Ljava/util/Collection;
    ...
    .line 1456
    .local v3, vlr:Ljava/util/Vector;,"Ljava/util/Vector<Lio/rong/push/common/stateMachine/StateMachine$LogRec;>;"
    iget-object v2, p0, Lio/rong/push/common/stateMachine/StateMachine;->mSmHandler:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;

    .line 1457
    .local v2, smh:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;
    if-eqz v2, :cond_0

    .line 1458
    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mLogRecords:Lio/rong/push/common/stateMachine/StateMachine$LogRecords;
    invoke-static {v2}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->access$1600(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;)Lio/rong/push/common/stateMachine/StateMachine$LogRecords;

    move-result-object v4

    #getter for: Lio/rong/push/common/stateMachine/StateMachine$LogRecords;->mLogRecVector:Ljava/util/Vector;
    invoke-static {v4}, Lio/rong/push/common/stateMachine/StateMachine$LogRecords;->access$1700(Lio/rong/push/common/stateMachine/StateMachine$LogRecords;)Ljava/util/Vector;
    ...
    .line 1459
    .local v1, lr:Lio/rong/push/common/stateMachine/StateMachine$LogRec;
    ...
    .end local v1           #lr:Lio/rong/push/common/stateMachine/StateMachine$LogRec;
    :cond_0
    return-object v3
.end method
...
.method protected final deferMessage(Landroid/os/Message;)V
    ...
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->deferMessage(Landroid/os/Message;)V
...
.method public dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {v4}, Lio/rong/push/common/stateMachine/StateMachine$LogRec;->toString()Ljava/lang/String;
    ...
    invoke-interface {v2}, Lio/rong/push/common/stateMachine/IState;->getName()Ljava/lang/String;
...
.method protected final getCurrentMessage()Landroid/os/Message;
    ...
    .line 1307
    .local v0, smh:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;
    if-nez v0, :cond_0
...
.method public final getLogRec(I)Lio/rong/push/common/stateMachine/StateMachine$LogRec;
    ...
    invoke-virtual {v1, p1}, Lio/rong/push/common/stateMachine/StateMachine$LogRecords;->get(I)Lio/rong/push/common/stateMachine/StateMachine$LogRec;
...
.method public final getLogRecCount()I
    ...
    invoke-virtual {v1}, Lio/rong/push/common/stateMachine/StateMachine$LogRecords;->count()I
...
.method public final getLogRecSize()I
    ...
    invoke-virtual {v1}, Lio/rong/push/common/stateMachine/StateMachine$LogRecords;->size()I
...
.method public isDbg()Z
    ...
    :cond_0
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->isDbg()Z
...
.method protected final isQuit(Landroid/os/Message;)Z
    ...
    .line 1874
    :cond_1
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->isQuit(Landroid/os/Message;)Z
...
.method protected final quit()V
    ...
    .line 1885
    :cond_0
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->quit()V
...
.method protected final quitNow()V
    ...
    .line 1896
    :cond_0
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->quitNow()V
...
.method public setDbg(Z)V
    ...
    .line 1920
    :cond_0
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->setDbg(Z)V
...
.method protected final setInitialState(Lio/rong/push/common/stateMachine/State;)V
    ...
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->setInitialState(Lio/rong/push/common/stateMachine/State;)V
...
.method public start()V
    ...
    .line 1932
    :cond_0
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->completeConstruction()V
...
.method protected final transitionTo(Lio/rong/push/common/stateMachine/IState;)V
    ...
    #calls: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->transitionTo(Lio/rong/push/common/stateMachine/IState;)V
...
.method protected final transitionToHaltingState()V
    ...
    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mHaltingState:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$HaltingState;
...
.method protected unhandledMessage(Landroid/os/Message;)V
    ...
    #getter for: Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDbg:Z
