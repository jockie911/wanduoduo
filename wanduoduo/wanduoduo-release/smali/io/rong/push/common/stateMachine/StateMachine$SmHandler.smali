...
.method private final addState(Lio/rong/push/common/stateMachine/State;Lio/rong/push/common/stateMachine/State;)Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    ...
    invoke-virtual {v3, v2}, Lio/rong/push/common/stateMachine/StateMachine;->log(Ljava/lang/String;)V
    ...
    .line 1138
    .local v0, parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    if-eqz p2, :cond_1
    ...
    .end local v0           #parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    check-cast v0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    .line 1140
    .restart local v0       #parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    if-nez v0, :cond_1

    .line 1142
    invoke-direct {p0, p2, v5}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->addState(Lio/rong/push/common/stateMachine/State;Lio/rong/push/common/stateMachine/State;)Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    ...
    .line 1146
    .local v1, stateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    if-nez v1, :cond_2

    .line 1147
    new-instance v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    .end local v1           #stateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    invoke-direct {v1, p0, v5}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;-><init>(Lio/rong/push/common/stateMachine/StateMachine$SmHandler;Lio/rong/push/common/stateMachine/StateMachine$1;)V

    .line 1148
    .restart local v1       #stateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    iget-object v2, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateInfo:Ljava/util/HashMap;
    ...
    .line 1152
    :cond_2
    iget-object v2, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    ...
    .restart local v1       #stateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    :cond_4
    iput-object p1, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/push/common/stateMachine/State;

    .line 1157
    iput-object v0, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    .line 1158
    const/4 v2, 0x0

    iput-boolean v2, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->active:Z
...
.method private final cleanupAfterQuitting()V
    ...
    #getter for: Lio/rong/push/common/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;
    ...
    #setter for: Lio/rong/push/common/stateMachine/StateMachine;->mSmThread:Landroid/os/HandlerThread;
    ...
    #setter for: Lio/rong/push/common/stateMachine/StateMachine;->mSmHandler:Lio/rong/push/common/stateMachine/StateMachine$SmHandler;
...
.method private final completeConstruction()V
    ...
    .prologue
    .line 923
    iget-boolean v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDbg:Z

    if-eqz v5, :cond_0

    iget-object v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mSm:Lio/rong/push/common/stateMachine/StateMachine;

    const-string v6, "completeConstruction: E"

    invoke-virtual {v5, v6}, Lio/rong/push/common/stateMachine/StateMachine;->log(Ljava/lang/String;)V
    ...
    .line 930
    .local v3, maxDepth:I
    iget-object v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateInfo:Ljava/util/HashMap;
    ...
    check-cast v4, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    .line 931
    .local v4, si:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    const/4 v0, 0x0
    ...
    .local v1, i:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    :goto_1
    if-eqz v1, :cond_2

    .line 933
    iget-object v1, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->parentStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    ...
    .end local v1           #i:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    .end local v4           #si:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    :cond_3
    iget-boolean v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDbg:Z
    ...
    .line 941
    :cond_4
    new-array v5, v3, [Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    iput-object v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStack:[Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    .line 942
    new-array v5, v3, [Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    iput-object v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mTempStateStack:[Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    ...
    sget-object v6, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mSmHandlerObj:Ljava/lang/Object;

    invoke-virtual {p0, v5, v6}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->obtainMessage(ILjava/lang/Object;)Landroid/os/Message;

    move-result-object v5

    invoke-virtual {p0, v5}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->sendMessageAtFrontOfQueue(Landroid/os/Message;)Z
...
.method private final invokeEnterMethods(I)V
    ...
    iget-object v1, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/push/common/stateMachine/State;

    invoke-virtual {v1}, Lio/rong/push/common/stateMachine/State;->enter()V
...
.method private final invokeExitMethods(Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;)V
    ...
    iget v2, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I
    ...
    iget-object v0, v1, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/push/common/stateMachine/State;

    .line 994
    .local v0, curState:Lio/rong/push/common/stateMachine/State;
    iget-boolean v1, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDbg:Z
    ...
    .line 999
    .end local v0           #curState:Lio/rong/push/common/stateMachine/State;
    :cond_1
    return-void
.end method
...
.method private final moveDeferredMessageAtFrontOfQueue()V
    ...
    .prologue
    .line 1022
    iget-object v2, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDeferredMessages:Ljava/util/ArrayList;
...
.method private final moveTempStateStackToStateStack()I
    ...
    iput v3, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I
    ...
    iget v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I
    ...
    iget-object v5, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStack:[Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    iget v6, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mStateStackTopIndex:I

    aget-object v5, v5, v6

    iget-object v5, v5, Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;->state:Lio/rong/push/common/stateMachine/State;

    invoke-virtual {v5}, Lio/rong/push/common/stateMachine/State;->getName()Ljava/lang/String;
...
.method private performTransitions(Lio/rong/push/common/stateMachine/State;Landroid/os/Message;)V
    ...
    .line 823
    .local v5, orgState:Lio/rong/push/common/stateMachine/State;
    iget-object v0, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mSm:Lio/rong/push/common/stateMachine/StateMachine;
    ...
    :cond_0
    :goto_1
    iget-object v8, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDestState:Lio/rong/push/common/stateMachine/State;

    .line 838
    .local v8, destState:Lio/rong/push/common/stateMachine/State;
    if-eqz v8, :cond_5
    ...
    .line 850
    :cond_1
    invoke-direct {p0, v8}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->setupTempStateStackWithStatesToEnter(Lio/rong/push/common/stateMachine/State;)Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;

    move-result-object v7

    .line 851
    .local v7, commonStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    invoke-direct {p0, v7}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->invokeExitMethods(Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;)V
    ...
    invoke-direct {p0, v10}, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->invokeEnterMethods(I)V
    ...
    .line 823
    .end local v7           #commonStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    .end local v8           #destState:Lio/rong/push/common/stateMachine/State;
    ...
    .line 871
    .restart local v7       #commonStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    .restart local v8       #destState:Lio/rong/push/common/stateMachine/State;
    .restart local v10       #stateStackEnteringIndex:I
    :cond_4
    const/4 v0, 0x0

    iput-object v0, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDestState:Lio/rong/push/common/stateMachine/State;
...
.method private final processMsg(Landroid/os/Message;)Lio/rong/push/common/stateMachine/State;
    ...
    .line 959
    .local v0, curStateInfo:Lio/rong/push/common/stateMachine/StateMachine$SmHandler$StateInfo;
    iget-boolean v1, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mDbg:Z
...
.method private final setupInitialStateStack()V
    ...
    iget-object v3, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mInitialState:Lio/rong/push/common/stateMachine/State;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    .prologue
    .line 779
    iget-boolean v1, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mHasQuit:Z
    ...
    .line 787
    .local v0, msgProcessedState:Lio/rong/push/common/stateMachine/State;
    ...
    .line 804
    .end local v0           #msgProcessedState:Lio/rong/push/common/stateMachine/State;
    :cond_1
    return-void

    .line 790
    .restart local v0       #msgProcessedState:Lio/rong/push/common/stateMachine/State;
    :cond_2
    iget-boolean v1, p0, Lio/rong/push/common/stateMachine/StateMachine$SmHandler;->mIsConstructionCompleted:Z
