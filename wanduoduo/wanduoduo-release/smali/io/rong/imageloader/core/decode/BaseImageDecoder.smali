...
.method protected considerExactScaleAndOrientatiton(Landroid/graphics/Bitmap;Lio/rong/imageloader/core/decode/ImageDecodingInfo;IZ)Landroid/graphics/Bitmap;
    ...
    .line 193
    .local v9, scaleType:Lio/rong/imageloader/core/assist/ImageScaleType;
    sget-object v0, Lio/rong/imageloader/core/assist/ImageScaleType;->EXACTLY:Lio/rong/imageloader/core/assist/ImageScaleType;

    if-eq v9, v0, :cond_0

    sget-object v0, Lio/rong/imageloader/core/assist/ImageScaleType;->EXACTLY_STRETCHED:Lio/rong/imageloader/core/assist/ImageScaleType;

    if-ne v9, v0, :cond_1

    .line 194
    :cond_0
    new-instance v10, Lio/rong/imageloader/core/assist/ImageSize;
    ...
    invoke-direct {v10, v0, v1, p3}, Lio/rong/imageloader/core/assist/ImageSize;-><init>(III)V

    .line 195
    .local v10, srcSize:Lio/rong/imageloader/core/assist/ImageSize;
    ...
    :goto_0
    invoke-static {v10, v1, v2, v0}, Lio/rong/imageloader/utils/ImageSizeUtils;->computeImageScale(Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/assist/ViewScaleType;Z)F
    ...
    invoke-virtual {v10, v8}, Lio/rong/imageloader/core/assist/ImageSize;->scale(F)Lio/rong/imageloader/core/assist/ImageSize;
    ...
    .end local v10           #srcSize:Lio/rong/imageloader/core/assist/ImageSize;
    :cond_1
    if-eqz p4, :cond_2
    ...
    .restart local v10       #srcSize:Lio/rong/imageloader/core/assist/ImageSize;
    :cond_5
    const/4 v0, 0x0
...
.method public decode(Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, v3, p1}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->defineImageSizeAndRotation(Ljava/io/InputStream;Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;

    move-result-object v2

    .line 81
    .local v2, imageInfo:Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;
    invoke-virtual {p0, v3, p1}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->resetStream(Ljava/io/InputStream;Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Ljava/io/InputStream;

    move-result-object v3

    .line 82
    iget-object v4, v2, Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;->imageSize:Lio/rong/imageloader/core/assist/ImageSize;

    invoke-virtual {p0, v4, p1}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->prepareDecodingOptions(Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Landroid/graphics/BitmapFactory$Options;
    ...
    .end local v2           #imageInfo:Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;
    :catchall_0
    move-exception v4
    ...
    .restart local v2       #imageInfo:Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;
    :cond_1
    iget-object v4, v2, Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;->exif:Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;

    iget v4, v4, Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;->rotation:I

    iget-object v5, v2, Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;->exif:Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;

    iget-boolean v5, v5, Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;->flipHorizontal:Z

    invoke-virtual {p0, v0, p1, v4, v5}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->considerExactScaleAndOrientatiton(Landroid/graphics/Bitmap;Lio/rong/imageloader/core/decode/ImageDecodingInfo;IZ)Landroid/graphics/Bitmap;
...
.method protected defineExifOrientation(Ljava/lang/String;)Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;
    ...
    sget-object v5, Lio/rong/imageloader/core/download/ImageDownloader$Scheme;->FILE:Lio/rong/imageloader/core/download/ImageDownloader$Scheme;

    invoke-virtual {v5, p1}, Lio/rong/imageloader/core/download/ImageDownloader$Scheme;->crop(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_0
    new-instance v5, Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;

    invoke-direct {v5, v4, v3}, Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;-><init>(IZ)V
    ...
    invoke-static {v5, v6}, Lio/rong/imageloader/utils/L;->w(Ljava/lang/String;[Ljava/lang/Object;)V
...
.method protected defineImageSizeAndRotation(Ljava/io/InputStream;Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;
    ...
    invoke-direct {p0, v1, v3}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->canDefineExifParams(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 110
    invoke-virtual {p0, v1}, Lio/rong/imageloader/core/decode/BaseImageDecoder;->defineExifOrientation(Ljava/lang/String;)Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;

    move-result-object v0

    .line 114
    .local v0, exif:Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;
    :goto_0
    new-instance v3, Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;
    ...
    iget v7, v0, Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;->rotation:I

    invoke-direct {v4, v5, v6, v7}, Lio/rong/imageloader/core/assist/ImageSize;-><init>(III)V

    invoke-direct {v3, v4, v0}, Lio/rong/imageloader/core/decode/BaseImageDecoder$ImageFileInfo;-><init>(Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;)V

    return-object v3

    .line 112
    .end local v0           #exif:Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;
    :cond_0
    ...
    .restart local v0       #exif:Lio/rong/imageloader/core/decode/BaseImageDecoder$ExifInfo;
    goto :goto_0
.end method
...
.method protected prepareDecodingOptions(Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/decode/ImageDecodingInfo;)Landroid/graphics/BitmapFactory$Options;
    ...
    .line 158
    .local v3, scaleType:Lio/rong/imageloader/core/assist/ImageScaleType;
    sget-object v7, Lio/rong/imageloader/core/assist/ImageScaleType;->NONE:Lio/rong/imageloader/core/assist/ImageScaleType;
    ...
    iget-boolean v7, p0, Lio/rong/imageloader/core/decode/BaseImageDecoder;->loggingEnabled:Z
    ...
    invoke-virtual {p1, v2}, Lio/rong/imageloader/core/assist/ImageSize;->scaleDown(I)Lio/rong/imageloader/core/assist/ImageSize;
    ...
    invoke-static {v7, v8}, Lio/rong/imageloader/utils/L;->d(Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_1
    sget-object v7, Lio/rong/imageloader/core/assist/ImageScaleType;->NONE_SAFE:Lio/rong/imageloader/core/assist/ImageScaleType;
    ...
    .line 164
    .local v4, targetSize:Lio/rong/imageloader/core/assist/ImageSize;
    sget-object v7, Lio/rong/imageloader/core/assist/ImageScaleType;->IN_SAMPLE_POWER_OF_2:Lio/rong/imageloader/core/assist/ImageScaleType;
    ...
    invoke-static {p1, v4, v7, v1}, Lio/rong/imageloader/utils/ImageSizeUtils;->computeImageSampleSize(Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/assist/ImageSize;Lio/rong/imageloader/core/assist/ViewScaleType;Z)I
