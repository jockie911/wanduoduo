...
.method public static createDiskCache(Landroid/content/Context;Lio/rong/imageloader/cache/disc/naming/FileNameGenerator;JI)Lio/rong/imageloader/cache/disc/DiskCache;
    ...
    invoke-static {v8}, Lio/rong/imageloader/utils/L;->e(Ljava/lang/Throwable;)V
    ...
    invoke-direct {v0, v7, v2, p1}, Lio/rong/imageloader/cache/disc/impl/UnlimitedDiskCache;-><init>(Ljava/io/File;Ljava/io/File;Lio/rong/imageloader/cache/disc/naming/FileNameGenerator;)V
...
.method public static createExecutor(IILio/rong/imageloader/core/assist/QueueProcessingType;)Ljava/util/concurrent/Executor;
    ...
    invoke-static {p1, v2}, Lio/rong/imageloader/core/DefaultConfigurationFactory;->createThreadFactory(ILjava/lang/String;)Ljava/util/concurrent/ThreadFactory;
...
.method public static createMemoryCache(Landroid/content/Context;I)Lio/rong/imageloader/cache/memory/MemoryCache;
    ...
    :cond_1
    new-instance v2, Lio/rong/imageloader/cache/memory/impl/LruMemoryCache;

    invoke-direct {v2, p1}, Lio/rong/imageloader/cache/memory/impl/LruMemoryCache;-><init>(I)V
...
.method private static createReserveDiskCacheDir(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {p0, v2}, Lio/rong/imageloader/utils/StorageUtils;->getCacheDirectory(Landroid/content/Context;Z)Ljava/io/File;
