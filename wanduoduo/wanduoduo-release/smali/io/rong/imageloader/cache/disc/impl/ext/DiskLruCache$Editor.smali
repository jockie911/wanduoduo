...
.method private constructor <init>(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;)V
    ...
    .line 773
    :cond_0
    #getter for: Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;->valueCount:I
...
.method public abort()V
    ...
    #calls: Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;->completeEdit(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;Z)V
...
.method public newInputStream(I)Ljava/io/InputStream;
    ...
    .line 781
    iget-object v3, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->this$0:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;

    monitor-enter v3

    .line 782
    :try_start_0
    iget-object v2, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->entry:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;
    ...
    iget-object v4, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->entry:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;

    invoke-virtual {v4, p1}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->getCleanFile(I)Ljava/io/File;
...
.method public newOutputStream(I)Ljava/io/OutputStream;
    ...
    .prologue
    .line 813
    iget-object v5, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->this$0:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;
    ...
    #getter for: Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->currentEditor:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;
    invoke-static {v4}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->access$800(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;)Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;
    ...
    #getter for: Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->readable:Z
    invoke-static {v4}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->access$700(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;)Z
    ...
    .line 818
    iget-object v4, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->written:[Z
    ...
    invoke-virtual {v4, p1}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Entry;->getDirtyFile(I)Ljava/io/File;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    :goto_0
    :try_start_3
    new-instance v4, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor$FaultHidingOutputStream;

    const/4 v6, 0x0

    invoke-direct {v4, p0, v3, v6}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor$FaultHidingOutputStream;-><init>(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;Ljava/io/OutputStream;Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$1;)V
    ...
    iget-object v4, p0, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache$Editor;->this$0:Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;

    #getter for: Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;->directory:Ljava/io/File;
    invoke-static {v4}, Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;->access$2000(Lio/rong/imageloader/cache/disc/impl/ext/DiskLruCache;)Ljava/io/File;
...
.method public set(ILjava/lang/String;)V
    ...
    :goto_0
    invoke-static {v0}, Lio/rong/imageloader/cache/disc/impl/ext/Util;->closeQuietly(Ljava/io/Closeable;)V
