 ...
 */
public class ReboundsScrollView extends ScrollView {
        ...
        public ReboundsScrollView(Context context) {
            super(context);
        }

        public ReboundsScrollView(Context context, AttributeSet attrs) {
            super(context, attrs);
        }
